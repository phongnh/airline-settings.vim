function! s:InitPowerlineStyles() abort
    if exists('s:airline_separator_styles')
        return
    endif

    let s:airline_separator_styles = {
                \ 'default': { 'left': "\ue0b0", 'right': "\ue0b2" },
                \ 'angle':   { 'left': "\ue0b0", 'right': "\ue0b2" },
                \ 'curvy':   { 'left': "\ue0b4", 'right': "\ue0b6" },
                \ 'slant':   { 'left': "\ue0bc", 'right': "\ue0ba" },
    ...
    let s:airline_subseparator_styles = {
                \ 'default': { 'left': "\ue0b1", 'right': "\ue0b3" },
                \ 'angle':   { 'left': "\ue0b1", 'right': "\ue0b3" },
                \ 'curvy':   { 'left': "\ue0b5", 'right': "\ue0b7" },
                \ 'slant':   { 'left': "\ue0bb", 'right': "\ue0bb" },
...
function! s:GetStyle(style) abort
    ...
    if l:style ==? 'random'
        ...
        let l:style = keys(s:airline_separator_styles)[l:rand % len(s:airline_separator_styles)]
    endif
...
function! s:SetStatuslineSeparators(style) abort
    ...
    let l:separator    = get(s:airline_separator_styles, l:style, s:airline_separator_styles['default'])
    let l:subseparator = get(s:airline_subseparator_styles, l:style, s:airline_subseparator_styles['default'])
